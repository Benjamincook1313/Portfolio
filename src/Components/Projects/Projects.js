...
function Projects() {
  ...
  const img = [Memory, CatchTracker, Dental, UsCounty, Quili]
    ...
    <div className='Projects' id='projects'>
      ...
      {showImg? 
        ...
        <div className='p-img-container'>
          <h4 className='p-title'>Quili</h4>
          <p> 
            Java | Spring Boot | Maven | IntelliJ | React | JavaScript | Bootstrap | SweetAlert2 |  
          </p>
        ...
        <div className='p-img-container' cursor='zoom-in'>
          ...
          <p> 
            React | JavaScript | NodeJS | Java | SpringBoot | Maven | Redux | SweetAlert2 | Bcrypt
          </p>
